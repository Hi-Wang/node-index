...
/***/ "../../../../../views/app/components/alert-model/alert-model.component.scss":
...
/***/ "../../../../../views/app/components/alert-model/alert-model.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AlertModelComponent; });
...
/***/ "../../../../../views/app/components/go-top/go-top.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../views/app/components/go-top/go-top.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var MessageRoomComponent = (function () {
    ...
    // 发送留言键盘监听
    MessageRoomComponent.prototype.keyDown = function (event, message) {
    ...
    // 循环显示blog和github
    MessageRoomComponent.prototype.BlogGithubShow = function (item) {
        var len = item.length;
        for (var i = 0; i < item.length; i++) {
            item[i].foorIndex = len - i;
            if (item[i].blog === '') {
                item[i].blogShow = false;
            }
            else {
                if (item[i].blog.indexOf('http://') === -1 || item[i].blog.indexOf('https://') === -1) {
                    item[i].blog = "http://" + item[i].blog;
                }
                item[i].blogShow = true;
            }
            if (item[i].github === '') {
                item[i].githubShow = false;
            }
            else {
                if (item[i].github.indexOf('http://') === -1 || item[i].github.indexOf('https://') === -1) {
                    item[i].github = "https://" + item[i].github;
                }
                item[i].githubShow = true;
            }
        }
        console.log(item);
    };
