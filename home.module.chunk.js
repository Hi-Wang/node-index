...
var HomeIndexComponent = (function () {
    ...
    // 时间差函数
    HomeIndexComponent.prototype.timeDiff = function () {
        // 时间差
        setInterval(function () {
            this.oldTime = "2018/3/18 15:07:00";
            this.dateBegin = new Date(this.oldTime);
            this.dateEnd = new Date();
            var dateDiff = this.dateEnd.getTime() - this.dateBegin.getTime(); //时间差毫秒数
            this.dayDiff = Math.floor(dateDiff / (24 * 3600 * 1000)); //时间差天数
